...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <h2 class="mt-3">Crear Empleado</h2>
      <div class="card">
        <div class="card-body">
          <form method="post" action="index.php?route=empleados_store">
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input name="fechaIngreso" type="date" class="form-control">
              </div>
              <div class="col-md-6 mb-3">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input name="sueldoBasico" type="number" step="0.01" class="form-control" value="0.00">
              </div>
            </div>
